...
Representative outputs of the resulting model: at 589 nm n ≈ 0.78, k ≈ 1.55 (deep-Drude regime since ω_visible ≪ ω_p); at 1.5 µm n ≈ 1.5, k ≈ 7.4; at 10 µm n ≈ 18.9, k ≈ 28.1. These values are qualitatively metallic but their absolute magnitudes are sensitive to the chosen ω_p and Γ — they should not be quoted as measured ZrC optical constants. **The qualitative form (Drude-dominated visible with k > n, fast IR rise) is correct; absolute values are model-specific** and may differ by factors of 2–3 from a properly measured bulk single crystal.
